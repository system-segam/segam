...
public final class SegamGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.ada.federate.rpc.RPCCommon.SSRequest,
      com.ada.federate.rpc.RPCCommon.SSMessage> getSecretSharingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "secretSharing",
      requestType = com.ada.federate.rpc.RPCCommon.SSRequest.class,
      responseType = com.ada.federate.rpc.RPCCommon.SSMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.ada.federate.rpc.RPCCommon.SSRequest,
      com.ada.federate.rpc.RPCCommon.SSMessage> getSecretSharingMethod() {
    io.grpc.MethodDescriptor<com.ada.federate.rpc.RPCCommon.SSRequest, com.ada.federate.rpc.RPCCommon.SSMessage> getSecretSharingMethod;
    if ((getSecretSharingMethod = SegamGrpc.getSecretSharingMethod) == null) {
      synchronized (SegamGrpc.class) {
        if ((getSecretSharingMethod = SegamGrpc.getSecretSharingMethod) == null) {
          SegamGrpc.getSecretSharingMethod = getSecretSharingMethod =
              io.grpc.MethodDescriptor.<com.ada.federate.rpc.RPCCommon.SSRequest, com.ada.federate.rpc.RPCCommon.SSMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "secretSharing"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ada.federate.rpc.RPCCommon.SSRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ada.federate.rpc.RPCCommon.SSMessage.getDefaultInstance()))
              .setSchemaDescriptor(new SegamMethodDescriptorSupplier("secretSharing"))
              .build();
        }
      }
    }
    return getSecretSharingMethod;
  }
  ...
  public static abstract class SegamImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void secretSharing(com.ada.federate.rpc.RPCCommon.SSRequest request,
        io.grpc.stub.StreamObserver<com.ada.federate.rpc.RPCCommon.SSMessage> responseObserver) {
      asyncUnimplementedUnaryCall(getSecretSharingMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getSecretSharingMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.ada.federate.rpc.RPCCommon.SSRequest,
                com.ada.federate.rpc.RPCCommon.SSMessage>(
                  this, METHODID_SECRET_SHARING)))
          .addMethod(
            getCommandMethod(),
            asyncUnaryCall(
              new MethodHandlers<
  ...
  public static final class SegamStub extends io.grpc.stub.AbstractAsyncStub<SegamStub> {
    ...
    public void secretSharing(com.ada.federate.rpc.RPCCommon.SSRequest request,
        io.grpc.stub.StreamObserver<com.ada.federate.rpc.RPCCommon.SSMessage> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getSecretSharingMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class SegamBlockingStub extends io.grpc.stub.AbstractBlockingStub<SegamBlockingStub> {
    ...
    /**
     */
    public com.ada.federate.rpc.RPCCommon.SSMessage secretSharing(com.ada.federate.rpc.RPCCommon.SSRequest request) {
      return blockingUnaryCall(
          getChannel(), getSecretSharingMethod(), getCallOptions(), request);
    }
  ...
  public static final class SegamFutureStub extends io.grpc.stub.AbstractFutureStub<SegamFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ada.federate.rpc.RPCCommon.SSMessage> secretSharing(
        com.ada.federate.rpc.RPCCommon.SSRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getSecretSharingMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_BATCH_QUERY = 1;
  private static final int METHODID_PUBIC_QUERY = 2;
  private static final int METHODID_PRIVATE_QUERY = 3;
  private static final int METHODID_PRIVATE_SET_UNION = 4;
  private static final int METHODID_SECURE_GROUP_BY_MAX = 5;
  private static final int METHODID_SECURE_GROUP_BY_MEDIAN = 6;
  private static final int METHODID_SECURE_GROUP_BY_SUM_SS = 7;
  private static final int METHODID_SECRET_SHARING = 8;
  private static final int METHODID_COMMAND = 9;
      ...
      switch (methodId) {
        ...
        case METHODID_SECURE_GROUP_BY_SUM_SS:
          serviceImpl.secureGroupBySumSS((com.ada.federate.rpc.RPCService.GroupBySumSSRequest) request,
              (io.grpc.stub.StreamObserver<com.ada.federate.rpc.RPCCommon.SSMessage>) responseObserver);
          break;
        case METHODID_SECRET_SHARING:
          serviceImpl.secretSharing((com.ada.federate.rpc.RPCCommon.SSRequest) request,
              (io.grpc.stub.StreamObserver<com.ada.federate.rpc.RPCCommon.SSMessage>) responseObserver);
          break;
      ...
      synchronized (SegamGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getSecretSharingMethod())
