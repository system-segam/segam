...
public class ResultKVSet {
    ...
    private Map<String, Integer> resultPair = new LinkedHashMap<>();
    ...
    public ResultKVSet(Map<String, Integer> map) {
        resultPair = map;
    }
     ...
     * @param val
     */
    public void updateRow(String key, Integer val) {
        if (!contains(key)) {
            addRow(key, val);
        } else {
            resultPair.put(key, val);
