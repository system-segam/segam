...
public class TestLiftedElGamal {
    ...
    public static void main(String[] args) {
        ...
        PublicKey PG = TestLiftedElGamal.generateRandomP(100);
        ...
        // 加密
        for (Integer m : M) {
            Ciphertext c = TestLiftedElGamal.encrypt(m, h, p, g);
            C.add(c);
        }
        ...
        int decM = TestLiftedElGamal.decrypt(cipherProduct, privateKeyList, p);
